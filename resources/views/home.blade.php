...
<nav class="navbar navbar-default hide" id="navi">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand croisant letra" href="{{route('principal')}}">laravel-guillospy</a>
    </div>
...
<div id="subtitle">aprende descarga y comparte </div>
<div  align="center">
...
<h3 class="text-center">{!!$pos->title!!}</h3>
 <div align="center">
	<img  class="img-responsive img-thumbnail" src="{!!$pos->photo!!}" title="{!!$pos->title!!}" />
 </div>

<h5 class="text-justify">{!!substr($pos->contennt, 0,100).'...'!!}</h5>
<div align="center">
